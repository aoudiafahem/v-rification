<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NouvEtudiant.aspx.cs" Inherits="teccart_PR.NouvEtudiant" %>
        ...
        <div>
            <table>
                <tr class="form-group" style="background-color: #ecf0f1;">
                    <td>E-mail Adresse<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                ...
                <tr class="form-group" style="background-color: #ecf0f1;">
                    <td>Mot Passe<asp:TextBox ID="TextBox2" runat="server" TextMode="Password"></asp:TextBox>
